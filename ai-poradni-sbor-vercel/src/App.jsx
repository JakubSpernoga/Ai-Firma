...
export default function AIAdvisoryBoard() {
  ...
  const [askColleague, setAskColleague] = useState(null); // {roleId, roleName} or null
  ...
  if (screen === "home") {
    return (
      <div style={{ fontFamily: font, background: "#0d0d0f", width: "100%", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", boxSizing: "border-box" }}>
        ...
        <div style={{ width: "100%", maxWidth: "1400px", height: "calc(100vh - 40px)", borderRadius: "16px", overflow: "hidden", boxShadow: "0 80px 180px rgba(0,0,0,0.7)", background: "#0d0d0f", position: "relative", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ padding: "32px 48px", display: "flex", alignItems: "center", gap: "16px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 48px 48px", position: "relative", zIndex: 1 }}>
            ...
            <div style={{ fontSize: "42px", fontWeight: 600, color: "#fff", lineHeight: 1.1, marginBottom: "8px" }}>S kym chces<br/>mluvit?</div>
            <div style={{ fontSize: "14px", fontWeight: 300, color: "rgba(255,255,255,0.4)", marginBottom: "40px", maxWidth: "400px", lineHeight: 1.7 }}>Kazdy clen tymu ma svou specializaci. Vyber roli a zacni konverzaci.</div>
            <div style={{ maxWidth: "750px", marginBottom: "24px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginBottom: "12px" }}>
                {ROLES.slice(0, 3).map((r) => (
                  <div key={r.id} onClick={() => openRole(r.id)} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "14px", padding: "24px 20px", cursor: "pointer", transition: "all 0.25s" }}
                    ...
                    <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", fontWeight: 600, color: "rgba(255,255,255,0.5)", marginBottom: "14px" }}>{r.initials}</div>
                    <div style={{ fontSize: "14px", fontWeight: 600, color: "#fff", marginBottom: "2px" }}>{r.title}</div>
                    <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", marginBottom: "8px" }}>{r.subtitle}</div>
                    <div style={{ fontSize: "11px", fontWeight: 300, color: "rgba(255,255,255,0.2)", lineHeight: 1.5 }}>{r.desc}</div>
                  </div>
                ))}
              </div>
            ...
            <div style={{ display: "flex", gap: "12px", maxWidth: "420px" }}>
              {[
                ...
                <div key={item.label} style={{ flex: 1, display: "flex", alignItems: "center", gap: "14px", padding: "14px 22px", background: "#fff", borderRadius: "60px", cursor: "pointer", transition: "all 0.2s", boxShadow: "0 4px 20px rgba(255,255,255,0.06)" }}
                  onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 8px 30px rgba(255,255,255,0.1)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 4px 20px rgba(255,255,255,0.06)"; }}>
  ...
  return (
    <div style={{ fontFamily: font, background: "#0d0d0f", width: "100%", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", boxSizing: "border-box" }}>
      ...
      <div style={{ width: "100%", maxWidth: "1400px", height: "calc(100vh - 40px)", borderRadius: "16px", overflow: "hidden", boxShadow: "0 80px 180px rgba(0,0,0,0.7)", display: "flex", background: "#f8f8f8" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          <div style={{ padding: "20px 32px", background: "#fff", borderBottom: "1px solid rgba(0,0,0,0.06)", display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div style={{ padding: "16px 32px 24px", background: dragOver ? "rgba(26,26,26,0.04)" : "transparent" }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", background: "#fff", borderRadius: "14px", padding: "6px 6px 6px 20px", border: "1px solid rgba(0,0,0,0.08)", boxShadow: "0 2px 12px rgba(0,0,0,0.03)" }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(0,0,0,0.25)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ cursor: "pointer", flexShrink: 0 }}><path d="M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48"/></svg>
              <input type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} onKeyDown={handleKeyDown} placeholder={`Zeptej se: ${role?.title || ""}...`} style={{ flex: 1, border: "none", outline: "none", fontFamily: font, fontSize: "13px", color: "#1a1a1a", background: "transparent" }} />
